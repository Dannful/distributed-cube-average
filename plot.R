...
df <- read_csv("dc.csv", show_col_types = FALSE, col_names = c("Nature", "Container",
...
df.states |>
    ...
    # Cosmetics
    xlab("Time [seconds]") + ylab("Rank [count]") + theme_bw(base_size = 14) + theme(plot.margin = unit(c(0,
      0, 0, 0), "cm"), legend.margin = margin(t = 0, unit = "cm"), panel.grid = element_blank(),
