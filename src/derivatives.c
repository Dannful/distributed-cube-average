...
float der1(const float* p, int i, int s, float dinv) {
    return (L1 * (p[i+s] - p[i-s]) +
            L2 * (p[i+2*s] - p[i-2*s]) +
            L3 * (p[i+3*s] - p[i-3*s]) +
            L4 * (p[i+4*s] - p[i-4*s])) * dinv;
}
...
float der2(const float* p, int i, int s, float d2inv) {
    return (K0 * p[i] +
            ...
            K2 * (p[i+2*s] + p[i-2*s]) +
            K3 * (p[i+3*s] + p[i-3*s]) +
            K4 * (p[i+4*s] + p[i-4*s])) * d2inv;
}

float derCross(const float* p, int i, int s11, int s21, float dinv) {
    float term1 = L11 * (p[i+s21+s11] - p[i+s21-s11] - p[i-s21+s11] + p[i-s21-s11]);
    float term2 = L12 * (p[i+s21+(2*s11)] - p[i+s21-(2*s11)] - p[i-s21+(2*s11)] + p[i-s21-(2*s11)]
                         + p[i+(2*s21)+s11] - p[i+(2*s21)-s11] - p[i-(2*s21)+s11] + p[i-(2*s21)-s11]);
    float term3 = L13 * (p[i+s21+(3*s11)] - p[i+s21-(3*s11)] - p[i-s21+(3*s11)] + p[i-s21-(3*s11)]
                         + p[i+(3*s21)+s11] - p[i+(3*s21)-s11] - p[i-(3*s21)+s11] + p[i-(3*s21)-s11]);
    float term4 = L14 * (p[i+s21+(4*s11)] - p[i+s21-(4*s11)] - p[i-s21+(4*s11)] + p[i-s21-(4*s11)]
                         + p[i+(4*s21)+s11] - p[i+(4*s21)-s11] - p[i-(4*s21)+s11] + p[i-(4*s21)-s11]);
    float term5 = L22 * (p[i+(2*s21)+(2*s11)] - p[i+(2*s21)-(2*s11)] - p[i-(2*s21)+(2*s11)] + p[i-(2*s21)-(2*s11)]);
    float term6 = L23 * (p[i+(2*s21)+(3*s11)] - p[i+(2*s21)-(3*s11)] - p[i-(2*s21)+(3*s11)] + p[i-(2*s21)-(3*s11)]
                         + p[i+(3*s21)+(2*s11)] - p[i+(3*s21)-(2*s11)] - p[i-(3*s21)+(2*s11)] + p[i-(3*s21)-(2*s11)]);
    float term7 = L24 * (p[i+(2*s21)+(4*s11)] - p[i+(2*s21)-(4*s11)] - p[i-(2*s21)+(4*s11)] + p[i-(2*s21)-(4*s11)]
                         + p[i+(4*s21)+(2*s11)] - p[i+(4*s21)-(2*s11)] - p[i-(4*s21)+(2*s11)] + p[i-(4*s21)-(2*s11)]);
    float term8 = L33 * (p[i+(3*s21)+(3*s11)] - p[i+(3*s21)-(3*s11)] - p[i-(3*s21)+(3*s11)] + p[i-(3*s21)-(3*s11)]);
    float term9 = L34 * (p[i+(3*s21)+(4*s11)] - p[i+(3*s21)-(4*s11)] - p[i-(3*s21)+(4*s11)] + p[i-(3*s21)-(4*s11)]
                         + p[i+(4*s21)+(3*s11)] - p[i+(4*s21)-(3*s11)] - p[i-(4*s21)+(3*s11)] + p[i-(4*s21)-(3*s11)]);
    float term10 = L44 * (p[i+(4*s21)+(4*s11)] - p[i+(4*s21)-(4*s11)] - p[i-(4*s21)+(4*s11)] + p[i-(4*s21)-(4*s11)]);
    return (term1 + term2 + term3 + term4 + term5 + term6 + term7 + term8 + term9 + term10) * dinv;
}
